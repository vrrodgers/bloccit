...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "Advertisement create" do
    it "increases the number of Advertisements by 1" do
      expect{ advertisement :create, params: { advertisement: { title: RandomData.random_sentence, body: RandomData.random_paragraph } } }.to change(Post,:count).by(1)
    end

    it "assigns the new advertisement to @advertisement" do
      advertisement :create, params: { advertisement: { title: RandomData.random_sentence, body: RandomData.random_paragraph } }
